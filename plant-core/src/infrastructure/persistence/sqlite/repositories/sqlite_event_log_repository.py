...
from infrastructure.persistence.sqlite.mappers import event_log_to_record, record_to_event_log
from infrastructure.persistence.sqlite.records import EventLogRecord
