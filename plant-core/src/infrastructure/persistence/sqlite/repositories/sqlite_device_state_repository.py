...
from infrastructure.persistence.sqlite.mappers import device_state_to_record, record_to_device_state
from infrastructure.persistence.sqlite.records import DeviceStateRecord
